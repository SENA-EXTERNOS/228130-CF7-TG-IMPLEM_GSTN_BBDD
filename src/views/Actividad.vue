    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        .titulo-segundo.color-acento-contenido
          h2 Procesos, reportes de fuentes de datos
        p.mb-4 El objetivo principal de la presente actividad es verificar los saberes más importantes del material correspondiente.
